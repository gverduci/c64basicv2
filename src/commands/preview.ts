...
function openPreviewBase(info: unknown, outputChannel: vscode.OutputChannel, context: vscode.ExtensionContext, previewColumn: vscode.ViewColumn) {
...
export function openPreview(info: unknown, outputChannel: vscode.OutputChannel, context: vscode.ExtensionContext) {
    openPreviewBase(info, outputChannel, context, vscode.ViewColumn.Beside);
}

export function refreshPreview(info: unknown, outputChannel: vscode.OutputChannel, context: vscode.ExtensionContext) {
