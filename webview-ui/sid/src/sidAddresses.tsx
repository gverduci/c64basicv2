...
const voice = [
  {
    addr: 0,
    bits: [{ bit: "7..0", names: [{ name: "Frequency low byte", value: "" }] }],
    rw: "w",
  },
  {
    addr: 1,
    bits: [
      { bit: "7..0", names: [{ name: "Frequency high byte", value: "" }] },
    ],
    rw: "w",
  },
  {
    ...
    bits: [
      {
        bit: "7..0",
        names: [{ name: "Pulse wave duty cycle low byte", value: "" }],
      },
    ],
    rw: "w",
  },
  {
    ...
    bits: [
      ...
      {
        bit: "3..0",
        names: [{ name: "Pulse wave duty cycle high byte", value: "" }],
      },
    ],
    rw: "w",
  },
    ...
    bits: [
      {
        bit: "7",
        names: [
          { name: "Noise", value: 128 },
          { name: "(Noise + Gate)", value: 129 },
        ],
      },
      {
        bit: "6",
        names: [
          { name: "Square", value: 64 },
          { name: "(Square + Gate)", value: 65 },
        ],
      },
      {
        bit: "5",
        names: [
          { name: "STooth", value: 32 },
          { name: "(STooth+ Gate)", value: 33 },
        ],
      },
      {
        bit: "4",
        names: [
          { name: "Triang", value: 16 },
          { name: "(Triang + Gate)", value: 17 },
        ],
      },
      { bit: "3", names: [{ name: "Test", value: 8 }] },
      { bit: "2", names: [{ name: "Ring", value: 4 }] },
      { bit: "1", names: [{ name: "Sync", value: 2 }] },
      { bit: "0", names: [{ name: "Gate", value: 1 }] },
    ],
    rw: "w",
  },
  {
    addr: 5,
    bits: [
      { bit: "7..4", names: [{ name: "Attack duration", value: "" }] },
      { bit: "3..0", names: [{ name: "Decay duration", value: "" }] },
    ],
    rw: "w",
  },
  {
    addr: 6,
    bits: [
      { bit: "7..4", names: [{ name: "Sustain level", value: "" }] },
      { bit: "3..0", names: [{ name: "Release duration", value: "" }] },
    ],
    rw: "w",
  },
];
...
const filter = [
  {
    ...
    bits: [
      { bit: "7..4", names: [{ name: "-", value: "" }] },
      { bit: "3..0", names: [{ name: "FC.lo", value: "" }] },
    ],
    rw: "w",
  },
  {
    addr: 22,
    bits: [{ bit: "7..0", names: [{ name: "FC.hi", value: "" }] }],
    rw: "w",
  },
  {
    addr: 23,
    bits: [
      { bit: "7..4", names: [{ name: "Res", value: "" }] },
      { bit: "3", names: [{ name: "Fx", value: 8 }] },
      { bit: "2..0", names: [{ name: "Filt", value: "" }] },
    ],
    rw: "w",
  },
  {
    addr: 24,
    bits: [
      { bit: "7", names: [{ name: "3OFF", value: 128 }] },
      { bit: "6", names: [{ name: "H", value: 64 }] },
      { bit: "5", names: [{ name: "B", value: 32 }] },
      { bit: "4", names: [{ name: "L", value: 16 }] },
      {
        bit: "3..0",
        names: [
          { name: "Volume", value: "" },
...
const misc = [
  {
    addr: 25,
    bits: [{ bit: "7..0", names: [{ name: "POTX", value: "" }] }],
    rw: "r",
  },
  {
    addr: 26,
    bits: [{ bit: "7..0", names: [{ name: "POTY", value: "" }] }],
    rw: "r",
  },
  {
    addr: 27,
    bits: [{ bit: "7..0", names: [{ name: "Osc", value: "" }] }],
    rw: "r",
  },
  {
    addr: 28,
    bits: [{ bit: "7..0", names: [{ name: "Env", value: "" }] }],
    rw: "r",
  },
];

const TabVoiceGrid: FC<IRegisterVoiceProps> = ({
  registers,
  voiceNumber,
  handleAddressClick,
  ...
  <VSCodeDataGrid gridTemplateColumns="60px 280px">
    ...
    {registers.map((row) => {
      ...
      if (voiceNumber) address = address + (voiceNumber - 1) * 7;
      return (
        <VSCodeDataGridRow>
          <VSCodeDataGridCell
          ...
          <VSCodeDataGridCell grid-column="2">
            {row.bits.map((b, index) => (
              <div style={{ display: "table" }}>
                <div style={{ display: "table-cell", minWidth: "30px" }}>
                  {b.bit}
                </div>
                {b.names.map((n, index) => {
                  if (n.value !== "")
